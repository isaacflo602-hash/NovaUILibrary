local Players = game("Players")local UIS = game("UserInputService")local TweenService = game("TweenService")local player = Players.LocalPlayer

local NovaUI = {}

local C = {Bg          = Color3.fromRGB(15, 15, 26),Card        = Color3.fromRGB(26, 26, 46),TabBar      = Color3.fromRGB(22, 22, 42),ActiveTab   = Color3.fromRGB(42, 42, 74),Accent      = Color3.fromRGB(124, 92, 252),AccentHover = Color3.fromRGB(160, 132, 255),Text        = Color3.fromRGB(255, 255, 255),Subtext     = Color3.fromRGB(136, 136, 170),Border      = Color3.fromRGB(42, 42, 74),ToggleOff   = Color3.fromRGB(50, 50, 80),ToggleOn    = Color3.fromRGB(124, 92, 252),HoverCard   = Color3.fromRGB(36, 36, 60),SliderTrack = Color3.fromRGB(35, 35, 58),}

local function addCorner(parent, radius)local c = Instance.new("UICorner")c.CornerRadius = UDim.new(0, radius)c.Parent = parentreturn cend

local function addStroke(parent, color, thickness)local s = Instance.new("UIStroke")s.Color = colors.Thickness = thickness or 1s.Parent = parentreturn send

local function addPadding(parent, left, top, right, bottom)local p = Instance.new("UIPadding")p.PaddingLeft = UDim.new(0, left or 0)p.PaddingTop = UDim.new(0, top or 0)p.PaddingRight = UDim.new(0, right or 0)p.PaddingBottom = UDim.new(0, bottom or 0)p.Parent = parentreturn pend

function NovaUI(titleText)local Window = {CurrentTab = nil,Tabs = {},TabButtons = {}}
